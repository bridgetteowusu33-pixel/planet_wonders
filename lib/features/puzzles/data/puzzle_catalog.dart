  ...
  PuzzlePack.fromJson(const {
    ...
    'puzzles': [
      ...
      },
      {
        'id': 'ghana_03_kente',
        'title': 'Kente Cloth',
        'image': 'assets/puzzles/ghana/full/ghana_03_kente.jpg',
        'thumbnail': 'assets/puzzles/ghana/thumbs/ghana_03_kente.png',
        'rows': 4,
        'cols': 5,
        'difficulty': 'medium',
        'targetTimeSec': 180,
      ...
      },
      {
        ...
        'title': 'Festival Time',
        'image': 'assets/puzzles/ghana/full/ghana_04_festival.jpg',
        'thumbnail': 'assets/puzzles/ghana/thumbs/ghana_04_festival.png',
        'rows': 5,
        'cols': 5,
        'difficulty': 'medium',
        'targetTimeSec': 210,
      ...
      },
      {
        'id': 'ghana_05_cocoa',
        'title': 'Cocoa Farm',
        'image': 'assets/puzzles/ghana/full/ghana_05_cocoa.jpg',
        'thumbnail': 'assets/puzzles/ghana/thumbs/ghana_05_cocoa.png',
        'rows': 6,
        'cols': 5,
        'difficulty': 'hard',
        'targetTimeSec': 300,
